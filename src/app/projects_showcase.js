      ...
      <div className="flex snap-x snap-mandatory w-full min-h-[300px] h-[25vw] overflow-x-auto">
        {projects.map((p, id)=>{
          ...
          return(
            <div 
              key={id} 
              className={`relative grid snap-start shrink-0 ${id == currentProjectIndex ? "w-[90vw] lg:w-[40vw]" : "w-[90vw] lg:w-[100px] xl:w-[150px]"} h-full overflow-hidden transition-all duration-500 ease-out select-none`}
